...
class ar2pnt:
    ...
    # Get state from move2pos node
    def stateCb(self,data):
        self.status = data.data

    # Get AR tag position data
    def arCb(self,data):
        artag = data
    ...
    # Update the visualization marker for the AR tag
    ...
    def imagecb(self,data):
        ...
        # If calibration has not yet been done...
        if self.calb == 0:
        ...
        # If in no plan has been found stage
        elif self.status == 4:
        ...
        # Else if in ready for next point stage
        else:
        ...
        if self.pnt:
            # Show the current 3D position of tag in cm
